          ...
          <Table size="small">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>Sri Krishna College</TableCell>
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell>
                  <strong>No. of Semesters Handled</strong>
                </TableCell>
                <TableCell>
                  <strong>Handled in Last 2 Semesters?</strong>
                </TableCell>
                <TableCell>
                  <strong>Actions</strong>
                </TableCell>
            ...
            <TableBody>
              <TableRow>
                <TableCell>Thermal Engineering</TableCell>
